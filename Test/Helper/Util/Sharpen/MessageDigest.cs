...
namespace SharpCifs.Util.Sharpen
{
        ...
        : MessageDigest where TAlgorithm : HashAlgorithm //, new() //use static `Create` method
    {
        ...
        private void Init()
        {
            ...
            Type algorithmType = typeof(TAlgorithm);
            MethodInfo createMethod = algorithmType.GetMethod("Create", BindingFlags.Public | BindingFlags.Static, null, Type.EmptyTypes, null);
