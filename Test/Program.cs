...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        {
            if (EDRQueryDictionary.ContainsKey(process))
            {
                matchedProcesses[process] = EDRQueryDictionary[process];
            }
        }
        ...
        {
            Console.WriteLine("已安装的杀毒软件及对应的进程:");
        ...
        {
            Console.WriteLine("未检测到已安装的杀毒软件。");
        }
    }
}
