...
namespace Org.Mentalis.Security.Cryptography
{
    ...
    {
        private readonly byte[] m_OAKLEY1024 = new byte[]
                                                   {
        ...
        private readonly byte[] m_OAKLEY1536 = new byte[]
                                                   {
                                                       0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xC9, 0x0F, 0xDA,
                                                       0xA2,
                                                       0x21, 0x68, 0xC2, 0x34, 0xC4, 0xC6, 0x62, 0x8B, 0x80, 0xDC, 0x1C,
                                                       ...
                                                       0x08,
                                                       0xCA, 0x23, 0x73, 0x27, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
                                                       0xFF
                                                   };

        private readonly byte[] m_OAKLEY768 = new byte[]
                                                  {
                                                      0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xC9, 0x0F, 0xDA,
                                                      0xA2,
                                                      0x21, 0x68, 0xC2, 0x34, 0xC4, 0xC6, 0x62, 0x8B, 0x80, 0xDC, 0x1C,
                                                      ...
                                                      0xE4, 0x85, 0xB5, 0x76, 0x62, 0x5E, 0x7E, 0xC6, 0xF4, 0x4C, 0x42,
                                                      0xE9,
                                                      0xA6, 0x3A, 0x36, 0x20, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
                                                      0xFF
                                                  };
        ...
        {
            get { return "1.2.840.113549.1.3"; // PKCS#3 OID
            }
        }
        ...
        private void Initialize(BigInteger p, BigInteger g, BigInteger x, int secretLen, bool checkInput)
        {
            ...
            if (x == null)
            {
                ...
                for (m_X = BigInteger.genRandom(secretLen);
                     m_X >= pm1 || m_X == 0;
                     m_X = BigInteger.genRandom(secretLen))
                {
                }
            }
            else
